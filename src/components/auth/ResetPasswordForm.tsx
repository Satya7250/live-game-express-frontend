        ...
        <div className="w-full p-8 rounded-[23px] bg-neutral-950/80 backdrop-blur-2xl flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <div className="mt-1 space-y-1">
              <h2 className="text-xl font-bold tracking-tight bg-gradient-to-r from-orange-400 via-white to-cyan-400 bg-clip-text text-transparent font-heading">Reset Password</h2>
              <p className="text-xs text-neutral-400">Establish a secure new password for your account</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-neutral-300 font-semibold text-xs uppercase tracking-wider">New Password</Label>
            ...
            {/* Confirm Password */}
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-neutral-300 font-semibold text-xs uppercase tracking-wider">Confirm New Password</Label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-500">
                  <Lock className="size-4" />
                </span>
          ...
          <div className="text-center">
            <Link href="/login" className="text-xs text-cyan-400 hover:text-orange-400 transition-all duration-300 font-semibold">
              Back to Login
            </Link>
          </div>
