        ...
        <div className="w-full p-8 rounded-[23px] bg-neutral-950/80 backdrop-blur-2xl flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <div className="mt-1 space-y-1">
              <h2 className="text-xl font-bold tracking-tight bg-gradient-to-r from-orange-400 via-white to-cyan-400 bg-clip-text text-transparent font-heading">Forgot Password</h2>
              <p className="text-xs text-neutral-400">Enter your email to receive a recovery link</p>
            </div>
          </div>
